...
export const Devices = {
    ...
    pH,
    sImage,
    zsHeadlineBold: 'SFCompactDisplay-Bold',
    zsHeadlineRegular: 'SFCompactDisplay-Regular',
    zsHeadlineLight: 'SFCompactDisplay-Light',
    zsHeadlineSemiBold: 'SFCompactDisplay-Semibold',
    zsHeadlineMedium: 'SFCompactDisplay-Medium',

    zsBodyMetaBold: 'SFCompactDisplay-Bold',
    zsBodyMetaRegular: 'SFCompactDisplay-Regular',
    zsBodyMetaLight: 'SFCompactDisplay-Light',
    zsBodyMetaSemiBold: 'SFCompactDisplay-Semibold',
    zsBodyMetaMedium: 'SFCompactDisplay-Medium',

    zsBodyBold: 'SFCompactDisplay-Bold',
    zsBodyRegular: 'SFCompactDisplay-Regular',
