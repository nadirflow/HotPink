...
const SOCIALS = {
    FACEBOOK: {
        key: 'fb',
        url: 'www.facebook.com/zinistoreapp',
    },
};
...
export const Devices = {
    ...
    pH,
    sImage,
    zsHeadlineBold: 'LibreBaskerville-Bold',
    zsHeadlineRegular: 'LibreBaskerville-Regular',
    zsHeadlineLight: 'LibreBaskerville-Regular',
    zsHeadlineSemiBold: 'LibreBaskerville-Bold',
    zsHeadlineMedium: 'LibreBaskerville-Regular',

    zsBodyMetaBold: 'LibreBaskerville-Bold',
    zsBodyMetaRegular: 'LibreBaskerville-Regular',
    zsBodyMetaLight: 'LibreBaskerville-Regular',
    zsBodyMetaSemiBold: 'SFCompactDisplay-Semibold',
    zsBodyMetaMedium: 'LibreBaskerville-Regular',

    zsBodyBold: 'LibreBaskerville-Bold',
    zsBodyRegular: 'LibreBaskerville-Regular',
    zsBodyLight: 'LibreBaskerville-Regular',
    zsBodySemiBold: 'LibreBaskerville-Bold',
    zsBodyMedium: 'LibreBaskerville-Regular',
};
export const Assets = {
