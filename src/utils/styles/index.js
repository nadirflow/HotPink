...
fontBold: {fontFamily: Devices.zsBodyBold},
  ...
  txt_title_header: { fontSize: Devices.fS(16), fontFamily: Devices.zsHeadlineSemiBold, color: Colors.WHITE_COLOR, },
  txt_title_button: { fontSize: Devices.fS(12), fontFamily: Devices.zsHeadlineLight, color: Colors.WHITE_COLOR, },
  ...
  txt_body_meta_item: { fontSize: Devices.fS(13), fontFamily: Devices.zsHeadlineRegular, color: Colors.PLACEHOLDER_COLOR, },
