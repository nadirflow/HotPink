      ...
      >
        ...
        {!state._loading &&
          <View style={[styles.con_content, { marginHorizontal: Devices.pH(layoutWidth.width), }]}>
            <CText numberOfLines={5} style={[styles.txt_title_header, { fontSize: cStyles.txt_title_group.fontSize * 1.5 }]}>{title}</CText>
                ...
                <CViewRow
                  leftComp={
                    <CImage
                      ...
                      source={{ uri: category.thumbnail.sizes["mobile-post-medium"] }}
                    />
                  }
                  rightComp={
                    <CText style={[styles.txt_categories, cStyles.ph_10]}>
            ...
            <HTML
              ...
              tagsStyles={{
                ...
                h1: {
                  color: cStyles.txt_title_group.color,
                ...
                h2: {
                  color: cStyles.txt_title_item.color,
