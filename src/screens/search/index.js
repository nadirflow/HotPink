            ...
            <View style={[Configs.supportRTL ? cStyles.column_align_start : cStyles.column_align_end]}>
              ...
              <View style={styles.con_content_price_2}>
                {currencyPosition === Currency.left &&
                  <CText style={[styles.txt_price_item, styles.txt_unit_item, percentSale !== 0 && { color: Colors.PLACEHOLDER_COLOR }]}>{symbol}</CText>
                }
                <CText style={[styles.txt_price_item, percentSale !== 0 && { color: Colors.PLACEHOLDER_COLOR, textDecorationLine: 'line-through' }]}>{price}</CText>
  ...
  _onRenderEmptySearch = () => {
    return (
      <View style={[cStyles.column_align_center, { marginTop: Devices.sW('40%') }]}>
        <Icon name={'search'} color={Colors.BORDER_COLOR} size={Devices.fS(50)} type={'light'} />
                  ...
                  return (
                    <TouchableOpacity onPress={() => this._onPressHistoryItem(item)}>
                      <View style={styles.con_history_item}>
                        <CText style={cStyles.txt_base_item}>{item}</CText>
                      </View>
                    </TouchableOpacity>
                  )
                }}
