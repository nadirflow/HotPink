            ...
            <View style={[
                ...
                <View style={[styles.con_info_store, { width: Devices.sW("33%") }]}>
                    <View style={styles.con_title_store}>
                        <CText style={styles.txt_title_store} numberOfLines={2}>{title}</CText>
                    </View>
                ...
                <View style={styles.con_content}>
                    ...
                    {state._options &&
                        ...
                        <View style={{ paddingHorizontal: Devices.pH(layoutWidth.width) }}>
                            <View style={styles.con_content_option}>
                                <CText style={styles.txt_header_accordion} i18nKey={'options'} />
                                                        ...
                                                        <CViewRow style={[styles.con_content_left_option, Configs.supportRTL && cStyles.row_justify_end]}
                                                            leftComp={
                                                                <Icon
                                                                    ...
                                                                    size={Devices.fS(20)}
                                                                    color={selected ? Colors.PRIMARY_COLOR : Colors.ICON_COLOR}
                                                                    type={"regular"}
                                                                />
                                                            }
                                                            rightComp={
                                                                <CText style={[Configs.supportRTL ? cStyles.pr_10 : cStyles.pl_10, selected ?
                                                                    [styles.txt_option_title_active, { color: Colors.PRIMARY_COLOR }] :
                                                                    [styles.txt_option_title, outOfStock && styles.txt_options_out_stock]]}>
                                                                    {label}
                                                                </CText>
                                                            }
                                                        />
                                                    ...
                                                    rightComp={price > 0 ?
                                                        <View style={[styles.con_content_right_option, Configs.supportRTL && cStyles.row_justify_start]}>
                                                            <CText style={selected ?
                                                                [styles.txt_option_price_active, { color: Colors.PRIMARY_COLOR }] :
                                                                [styles.txt_option_price, outOfStock && styles.txt_options_out_stock]}>{'+ '}</CText>

                                                            {currencyPosition === Currency.left &&
                                                                <CText style={selected ?
                                                                    [styles.txt_option_price_active, { color: Colors.PRIMARY_COLOR }] :
                                                                    [styles.txt_option_price, outOfStock && styles.txt_options_out_stock]}>{currency}</CText>
                                                            }
                                                            <CText style={selected ?
                                                                [styles.txt_option_price_active, { color: Colors.PRIMARY_COLOR }] :
                    ...
                    {Configs.showRelatedProduct &&
                        <View style={styles.con_list_store}>
                            <CText style={[styles.txt_title_related, { paddingHorizontal: Devices.pH(layoutWidth.width) }]}
                ...
                <CViewRow between style={[styles.con_btn_group, { paddingHorizontal: Devices.pH(layoutWidth.width) }, cStyles.pb_10 ]}
                    leftComp={
                        state._product.stock_status === Configs.stockStatus.IN_STOCK ?
                            ...
                            >
                                ...
                                :
                                    <CText style={styles.txt_add_cart}>{Languages[props.language].add_to_cart}</CText>
                                }
                    ...
                    rightComp={
                        state._isAdd ?
                            ...
                            >
                                <CText style={styles.txt_add_cart}>{Languages[props.language].view_cart}</CText>
                            </Button> : <View />
                    }
                /> 
            </View>
